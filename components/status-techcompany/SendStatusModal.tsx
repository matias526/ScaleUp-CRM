  ...
  const sendEmail = async () => {
    ...
    try {
      ...
      const messages = emailRecipients.map((email) => {
        ...
        const language = recipient?.preferred_language || "es"
