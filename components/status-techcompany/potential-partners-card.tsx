...
const POTENTIAL_PARTNERS_TRANSLATIONS = {
  ...
  "potential.estimatedClose": { es: "Cierre estimado", en: "Estimated close", pt: "Fechamento estimado" },
  "potential.noCloseDate": { es: "Sin fecha de cierre", en: "No close date", pt: "Sem data de fechamento" },
} as const
