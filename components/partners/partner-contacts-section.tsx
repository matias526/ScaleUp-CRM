...
export function PartnerContactsSection({ partnerId }: PartnerContactsSectionProps) {
  ...
  const handleAddContact = async (contact: Contact) => {
    try {
      ...
      toast({
        title: "Éxito",
        description: "Contacto agregado al partner",
      })
    } catch (error) {
  ...
  const handleRemoveContact = async () => {
    ...
    try {
      ...
      toast({
        title: "Éxito",
        description: "Contacto removido del partner",
      })
    } catch (error) {
    ...
    <>
      ...
      <AlertDialog open={!!contactToRemove} onOpenChange={(open) => !open && setContactToRemove(null)}>
        <AlertDialogContent>
          ...
          <AlertDialogDescription>
            {t("contacts.removeConfirm.partner")}
          </AlertDialogDescription>
