...
INSERT INTO translations (key, language, value) VALUES ('users.form.new_password', 'es', 'Nueva contrase��a') ON CONFLICT (key, language) DO UPDATE SET value = EXCLUDED.value;
...
INSERT INTO translations (key, language, value) VALUES ('users.details.back', 'en', 'Back') ON CONFLICT (key, language) DO UPDATE SET  value) VALUES ('users.details.back', 'en', 'Back') ON CONFLICT (key, language) DO UPDATE SET value = EXCLUDED.value;
